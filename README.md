...
本博客基于 [Docusaurus 2](https://v2.docusaurus.io/) JAMStack 静态网站生成器与[柠檬果肉博客网站](https://zxuqian.cn/)实现，作为 Bilibili（柠檬果肉） 视频的文本版载体呈现与个人前端知识总结归纳分析。本博客网站专注前端发展与技术分享，至死不渝！
